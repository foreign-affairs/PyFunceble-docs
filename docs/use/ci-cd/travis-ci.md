...
The idea is to run PyFunceble within an instance and let PyFunceble push the
result into a Git Repository.
...
the results. If your repository is hosted on GitHub, you have
to [generate a new GitHub PAT](https://github.com/settings/tokens/new) with _(at
least)_ the `public_repo` scope.

Once created and copied in a safe place, you can use the Travis CI CLI to embed
your
...
Here is an example that demonstrate how to use PyFunceble within a Travis CI
instance.
